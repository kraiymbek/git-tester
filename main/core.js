...
class ThermalPrinter {
  ...
  customLeftCyrrilicOriented(leftwidth, left,  right) {
    this.append(left);
    var width = this.config.width - leftwidth.length - right.toString().length;
    for (var i = 0; i < width; i++) {
      this.append(Buffer.from(" "));
    }
    this.append(right);
  ...
  customRightCyrrilicOriented(rightwidth, left,  right) {
    this.append(left);
    var width = this.config.width - left.toString().length - rightwidth.toString().length;
    for (var i = 0; i < width; i++) {
      this.append(Buffer.from(" "));
    }
    this.append(right);
